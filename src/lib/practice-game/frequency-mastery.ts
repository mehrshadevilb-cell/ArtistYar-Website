...
export function buildSessionPlan(opts: {
  ...
  // Advanced: strong precision + rich evidence → relative discrimination as preference
  let exercisePreference: SessionPlan["exercisePreference"] =
