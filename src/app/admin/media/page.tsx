...
export default function AdminMediaPage() {
  ...
  async function removeItem(item: MediaItem) {
    if (!window.confirm(`محتوای «${item.title}» حذف شود؟ این کار فایل را از Cloudinary هم حذف می‌کند.`)) return;
