      ...
      <main className="page-shell">
        <section className="container-ay py-16 sm:py-24">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Link href="/courses#p-1" className="btn-primary">شروع مسیر راهِ‌یار</Link>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_.9fr]">
            <article className="card-ay p-7 md:p-10">
              ...
              <div className="mt-6 space-y-5 text-sm leading-8 text-ink-300">
                <p>در آموزش تنظیم موسیقی و آهنگ‌سازی، هدف فقط اضافه‌کردن لایه‌های بیشتر نیست. باید بدانی هر صدا چه نقشی دارد، در چه محدوده‌ای قرار می‌گیرد و چگونه با ریتم، ملودی و فضای قطعه ارتباط می‌گیرد. انتخاب صدای مناسب در بسیاری از مواقع از پردازش سنگین مهم‌تر است.</p>
          ...
          <div className="grid gap-8 lg:grid-cols-[.85fr_1.15fr]">
            ...
            <div>
              ...
              <div className="mt-7 space-y-4">
                {["هفتهٔ اول: گوش‌دادن تحلیلی، تئوری پایه و شناخت مسیر سیگنال", "هفتهٔ دوم: آهنگ‌سازی، انتخاب صدا، ساختار، ریتم و arrangement", "هفتهٔ سوم: بالانس، پنینگ، EQ و کمپرس روی پروژهٔ خودت", "هفتهٔ چهارم: فضا، automation، اصلاحات و آماده‌سازی خروجی"].map((item, index) => (
        ...
        <section className="container-ay pb-16 sm:pb-24">
          <div className="mx-auto max-w-4xl">
            <SectionHeading eyebrow="/ پرسش‌های متداول" title="سؤال‌های رایج دربارهٔ آموزش تنظیم، میکس و مسترینگ" subtitle="اگر سؤال دیگری داری، راهِ‌یار AI برای بررسی مسیر و پروژه‌ات در دسترس است." />
