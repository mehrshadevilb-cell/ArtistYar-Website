  ...
  return (
    <main className="container-ay py-12 sm:py-16">
      ...
      <p className="mt-3 max-w-2xl text-sm leading-7 text-ink-400">
        رکوردهای بازی‌ها، XP، اشتراک Pro و جایگاه جدول امتیازات اینجا جمع می‌شوند. هر تغییری که ادمین روی اشتراک اعمال کند، در همین پروفایل دیده می‌شود.
      </p>
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-3">
        ...
        <div className="card-ay p-4">
          ...
          <strong className="mt-2 block text-lg text-sand-50">تا Level ۵۰۰</strong>
          <Link href="/practice" className="mt-1 inline-block text-xs text-gold-300 hover:text-gold-200">
            ادامه تمرین ←
          </Link>
        </div>
      </div>
