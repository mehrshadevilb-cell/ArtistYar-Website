...
export default function AssistantPage() {
  ...
  // No blocking provider health-check: first answer request starts immediately.
          ...
          <aside className="space-y-3 lg:sticky lg:top-28">
            ...
            {connection === "offline" ? (
              <div className="flex items-start gap-2 rounded-2xl border border-gold-500/20 bg-gold-500/[0.06] p-4 text-[11px] leading-6 text-ink-300">
                ...
                <button type="button" onClick={() => setConnection("loading")} className="sr-only">بستن</button>
              </div>
            ) : null}
          </aside>
        </div>
