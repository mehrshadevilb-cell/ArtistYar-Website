              ...
              {activeLesson.video_url ? (
                ...
                <div className="relative flex aspect-video items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_50%_30%,rgba(201,162,39,.2),transparent_42%),#10100e] p-8 text-center">
                  <div className="relative max-w-sm">
                    ...
                    <p className="mt-4 text-sm font-medium text-sand-50">ویدیو به‌زودی در این درس قرار می‌گیرد</p>
                    <p className="mt-2 text-xs leading-6 text-ink-400">ادمین می‌تواند لینک ویدیو را از پنل مدیریت وارد کند.</p>
                  </div>
                </div>
              )}
            </div>
