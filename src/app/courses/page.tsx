...
export default function CoursesPage() {
  ...
  async function onOrder(e: FormEvent<HTMLFormElement>) {
    ...
    setBusy(true); setMsg(""); setPaymentId(null); setReceipt(null); setReceiptMsg("");
