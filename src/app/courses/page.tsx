...
export default function CoursesPage() {
  ...
  return <section className="container-ay py-16">
    ...
    {copyToast ? <div className="pointer-events-none fixed inset-x-4 bottom-6 z-50 flex justify-center" role="status" aria-live="polite"><div className="flex items-center gap-3 rounded-2xl border border-emerald-300/25 bg-[#10251f]/95 px-4 py-3 text-sm text-emerald-100 shadow-[0_14px_40px_rgba(16,185,129,.22)] backdrop-blur-xl"><span className="flex h-7 w-7 items-center justify-center rounded-full bg-emerald-400/15 text-emerald-300"><Check size={16} strokeWidth={2.8} /></span><span>شماره کارت با موفقیت کپی شد</span></div></div> : null}
  </section>;
}
