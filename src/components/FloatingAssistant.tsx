 ...
 * Hidden on chat/tool surfaces where it collides with composers.
 */
export function FloatingAssistant() {
  ...
  // Hide on all chat / focused-tool surfaces where the FAB collides with the composer
  if (
    pathname?.startsWith("/assistant") ||
    pathname?.startsWith("/hitnevis") ||
    pathname?.startsWith("/ai-music") ||
    pathname?.startsWith("/music-analyzer") ||
