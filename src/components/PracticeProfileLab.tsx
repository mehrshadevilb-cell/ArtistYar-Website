...
export function PracticeProfileLab({ onBack }: Props) {
  return (
    <div className="container-ay min-h-[50vh] py-8" dir="rtl">
      ...
      <h1 className="mt-4 text-xl font-semibold text-sand-50">پروفایل تمرین</h1>
      <p className="mt-2 text-sm leading-6 text-ink-500">امتیاز مهارت، XP، استریک و لیدربورد.</p>
